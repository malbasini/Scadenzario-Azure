...
namespace Scadenzario.Models.InputModels.Scadenze
{
    ...
    public class ScadenzaEditInputModel
    {
        ...
        [MinLength(3, ErrorMessage = "Il beneficiario dev'essere di almeno {1} caratteri"),
         ...
         RegularExpression(@"^[0-9A-z\u00C0-\u00ff\s\.']+$",
             ErrorMessage =
                 "Beneficiario non valido"), //Questa espressione regolare include anche i caratteri accentati
        ...
        [Display(Name = "Giorni Ritardo")] public int? GiorniRitardo { get; set; }
        [Display(Name = "Sollecito")] public bool Sollecito { get; set; }
